...
```{r}
extract <- avonet_extract_intraspecies(taxon_system = "birdlife", traits = c("sex", ".length"))
extract_clean <- avonet_extract_intraspecies(taxon_system = "birdlife", traits = c("sex", ".length"), clean = "all")
...
```{r}
avg <- avonet_extract_interspecies(traits = c("tail.length", "wing.length"))
avg
```
