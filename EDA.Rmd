...
```{r}
avonet_install(filename = "raw_data/AVONET Supplementary dataset 1.xlsx")
```
...
```{r}
avonet <- avonet_load(filename = "raw_data/AVONET Supplementary dataset 1.xlsx",
                      clean = "all")
avonet
```
...
```{r}
extract <- avonet_extract_intraspecies(filename = "raw_data/AVONET Supplementary dataset 1.xlsx", taxon_system = "birdlife", traits = c("sex", ".length"))
extract_clean <- avonet_extract_intraspecies(filename = "raw_data/AVONET Supplementary dataset 1.xlsx", taxon_system = "birdlife", traits = c("sex", ".length"), clean = "all")
...
```{r}
avg <- avonet_extract_interspecies(filename = "raw_data/AVONET Supplementary dataset 1.xlsx", traits = c("tail.length", "wing.length"))
avg
```
