...
p <- ggplot(summary_plot_family, mapping = aes(genus, tail.length)) + 
  ...
  xlab("genus") +
  ylab("tail length (mm)") +
  labs(title = "Tail Length Variation of Males in \nGenera of the Acanthizidae Family") +
  theme(panel.background = element_rect(fill = "#D5E7D7"),
        plot.background = element_rect(fill = "#D5E7D7"),
        plot.title = element_text(colour = "#094595", size = 30),
        axis.title = element_text(colour = "#094595", size = 20),
