...
```{r}
extract <- avonet_extract_intraspecies(taxon_system = "birdlife", traits = c(".length"))
extract_clean <- avonet_extract_intraspecies(taxon_system = "birdlife", traits = c(".length"), clean = "all")
