...
AvoNet is stored across 9 related excel spreadsheets making it difficult to explore and interact with. Other datasets stored similarly (e.g. AusTraits, Atlas of Living Australia) have dedicated R-packages to streamline their use (Falster et al., 2021; Westgate et al., 2023). An R-package that interfaces with AvoNet would facilitate EDA and aid in addressing specific research questions.
