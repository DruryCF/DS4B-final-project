...
extract_clean <- extract_avonet(taxon_system = "birdlife", taxon_level = "family", traits = c(".length"), clean = "all")
...
```{r}
summary2 <- summary_avonet(data = avg, group = c("family"), stats = c("mean", "median", "max", "min", "sd"), tidy = FALSE)
summary2
```
