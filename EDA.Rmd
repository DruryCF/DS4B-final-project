...
```{r}
extract <- avonet_extract_intraspecies(taxon_system = "birdlife", taxon_level = "family", traits = c(".length"))
extract_clean <- avonet_extract_intraspecies(taxon_system = "birdlife", taxon_level = "family", traits = c(".length"), clean = "all")
